...
\title{Directed Gaze For Character Animation}
...
\include{gazemodel/gazemodel}
\include{conversationalrolegaze/conversationalrolegaze}
\include{stylizedgaze/stylizedgaze}
\include{gazeauthoring/gazeauthoring}
